...
技法数・ルール数は検知品質を保証しません。WIN-031はWIN-018の詳細化であり、独立した証拠として二重計上しません。P3は補助シグナルです。

|ログ|P1|P2|P3|
|---|---:|---:|---:|
|Windows Event|10|20|1|
|FW|0|4|6|
|Proxy|0|7|13|
|DNS|0|2|5|
