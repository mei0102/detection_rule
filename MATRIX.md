...
|[T1027.003 Steganography](https://attack.mitre.org/techniques/T1027/003)|[WIN-028](rules/windows/WIN-028.md)|—|—|—|
...
|[T1218.005 Mshta](https://attack.mitre.org/techniques/T1218/005)|[WIN-016](rules/windows/WIN-016.md), [WIN-026](rules/windows/WIN-026.md)|—|—|—|
...
|[T1543.003 Windows Service](https://attack.mitre.org/techniques/T1543/003)|[WIN-010](rules/windows/WIN-010.md), [WIN-032](rules/windows/WIN-032.md)|—|—|—|
|[T1547.001 Registry Run Keys / Startup Folder](https://attack.mitre.org/techniques/T1547/001)|[WIN-030](rules/windows/WIN-030.md)|—|—|—|
...
|[T1685 Disable or Modify Tools](https://attack.mitre.org/techniques/T1685)|[WIN-021](rules/windows/WIN-021.md), [WIN-031](rules/windows/WIN-031.md)|—|—|—|
...
技法数・ルール数は検知品質を保証しません。WIN-031はWIN-018の詳細化。WIN-032とWIN-010が同じサービス登録を捉えた場合も独立した侵害証拠として二重加点しません。P3は補助シグナルです。

|ログ|P1|P2|P3|
|---|---:|---:|---:|
|Windows Event|10|21|1|
|FW|0|4|6|
|Proxy|0|7|13|
|DNS|0|2|5|
